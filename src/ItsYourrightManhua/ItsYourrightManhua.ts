...
const SOURCE_DOMAIN = "https://itsyourightmanhua.com"

export class ItsYourrightManhua extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'ItsYourrightManhua' }
    get description(): string { return 'manhua' }
    get author(): string { return 'Dev' }
